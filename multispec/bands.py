...
from .parameters import FitParameter, ArrayParameter

class SpectralBand:
    """
    Default band type used to read in parameters present for all band types (center, width, amplitudes)
    """
    def __init__(self, name: str, config_dict: dict, expected_keys: list[str] | None = None, field_indices: list[int] | None = None) -> None:
        self.name = name
