        ...
        if self.is_vtvh:
            ...
            if select_fields is not None:
                self.active_field_indices = [
                    i for i, f in enumerate(self.master_fields)
            ...
            if select_temps is not None:
                self.active_temp_indices = [
                    i for i, t in enumerate(self.master_temperatures)
                ...
                self.toml_temperatures = [self.master_temperatures[i] for i in self.active_temp_indices]
            else:
